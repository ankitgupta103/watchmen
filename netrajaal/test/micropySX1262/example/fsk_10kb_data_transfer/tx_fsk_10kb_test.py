"""
TX Test: Send 10KB of data using high-speed FSK mode
OpenMV RT1062 + Waveshare Core1262-868M

This script sends 10KB (10,240 bytes) of data using high-speed FSK configuration:
...
# Note: FSK doesn't have getTimeOnAir() like LoRa, so we calculate manually
# Time on air = (preamble + sync + packet_length + CRC) / bit_rate
if num_packets > 0:
